...
if(isset($_POST['finalizar'])) { 
    ...
    //compravenda
    $sql = "INSERT INTO compravenda (cliente_id, vendedor_id, desconto) 
    VALUES ('" . $cliente_id[0] . "', '$vendedor_id', '$desconto')"; //usuario_id,  {$_SESSION['id']}, 
    ...
    for ($i = 0; $i < count($produto_id); $i++){
        $sql = "insert into compravendaproduto (compravenda_id, produto_id, quantidade, valorunitario)
            ...
            <ul class="list-group mb-3">
                ...
                <div class="input-group text-right">
                    ...
                    <div class="input-group-append">
                        <button type="button" class="btn btn-secondary" id="btnAplicarDesconto"><i class="bi bi-check-lg"></i></button>
                    </div>
                </div>
