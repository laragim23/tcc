...
if (isset($_POST['finalizar'])) {
    ...
    if ($statusCliente === 'inativo') {
        ...
        if ($statusVendedor === 'inativo') {
            ...
            //compravenda
            $sql = "INSERT INTO compravenda (cliente_id, vendedor_id, desconto, operacao, formaPagamento, situacao) 
            VALUES ('" . $cliente_id[0] . "', '$vendedor_id', '$desconto', '$operacao', '$formaPagamento', '$situacao')"; //usuario_id,  {$_SESSION['id']}, 
