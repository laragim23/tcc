...
$sql = "SELECT v.id, c.nome as vendedor, v.datacriacao
        FROM compravenda v
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <a href="relatorio_vendas_cliente.php" class="btn btn-primary"><i class="bi bi-people"></i></a>
                <a href="relatorio_condicionais_vendedor.php" class="btn btn-primary"><i class="bi bi-basket"></i></a> 
                </h5>
                    ...
                    <tbody>
                        <?php while ($linha = mysqli_fetch_array($resultado)) { ?>
                            <tr>
                                ...
                                <a href="relatorio_vendas_vendedor.php? id=<?= $linha['id'] ?>" class="btn btn-danger"
