...
$sql = "select * from condicional where id = " . $_GET['id'];
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Alterar Condicional</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body">
              ...
              <input type="hidden" class="form-control" value="<?= $linha['id'] ?>" name="id">
                    <div class="col-md-12">
                        ...
                        <select name="cliente_id" class="form-select" value="<?=$linha['cliete_id'] ?>" name="cliente_id">
                ...
                <div class="col-md-6">
                    ...
                    value="<?=$linha['telefone'] ?>" name="telefone" required><span class="mascara"></span>
                </div>
                ...
                <div class="col-md-12">
                        ...
                        value="<?=$linha['vendedor_id'] ?>" name="vendedor_id">
                            <option selected>Selecione</option>
                            <?php
                ...
                <div class="col-md-6">
                        ...
                        value="<?=$linha['produto_id'] ?>" name="produto_id">
                            <option selected>Selecione</option>
                            <?php
